...
panel's raw ADC range doesn't use the full 0-4095 sweep, X reads
inverted relative to the rendered screen, and Y reads direct. If taps
land in the wrong spot, re-run discover_touch.py and adjust the
RAW_*_MIN/MAX constants to match.
"""
import threading
...
RAW_Y_MIN, RAW_Y_MAX = 320, 3680  # top edge -> bottom edge
